...
### CaMeL orchestrated with Temporal logic for static verification and liveness

[![arXiv](https://img.shields.io/badge/arXiv-TODO-b31b1b.svg)](https://arxiv.org/abs/TODO)

**Elia Nikolaou**<sup>1</sup> · **Magnus Wiik Eckhoff**<sup>2,3</sup> · **Robert Flood**<sup>3</sup> · **Gudmund Grov**<sup>2,3</sup> · **Vasileios Mavroeidis**<sup>3</sup> · **David Aspinall**<sup>1</sup>

<sup>1</sup>University of Edinburgh &nbsp;&nbsp;<sup>2</sup>Norwegian Defence Research Establishment &nbsp;&nbsp;<sup>3</sup>University of Oslo

---

CaMeLoT extends [CaMeL](https://arxiv.org/abs/2503.18813)'s runtime capability-based policies with **static verification**: agentic plans generated by the privileged LLM are model-checked against temporal (CTL) properties — covering both security (data provenance never reaches a sensitive sink) and liveness (the plan is guaranteed to terminate) — before they are ever executed.

This repository is a fork of CaMeL. See the [**CaMeLoT README**](src/camel/ext/README.md) for the full write-up of the extension (architecture, state machine construction, CTL policies, and the verification/repair loop).

The original CaMeL README follows below.
